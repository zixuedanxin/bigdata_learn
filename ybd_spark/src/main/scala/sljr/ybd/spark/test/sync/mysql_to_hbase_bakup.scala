...
class sync_hbase(zk_hosts:String,kafkaoffset_hbase_table:String) extends Serializable {
...
object mysql_to_hbase_bakup {
  ...
  def str_to_json(topare:String) :Tuple2[String,String]={
    ...
    while (iter.hasNext){
      ...
      var value = datas.get(instance).toString
      println("key: " + instance + " value:" + value)
    }*/
    //datas += ("diu_type_in_hbase"->"ds")
