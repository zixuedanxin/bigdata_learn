...
/**
  * Spark商业案例书稿第18章：  婚恋社交网络多维度分析案例 婚恋社交网络多维度分析的案例代码
  * 版权：DT大数据梦工厂所有
  * 时间：2017年4月19日；
  *
  ***/
...
object SNSAnalysisGraphX {
  def main(args: Array[String]) {
    ...
    graph.mapVertices { case (id, (name, age)) => (id, (name, age + 10)) }.vertices.collect.foreach(v => println(s"${v._2._1} is ${v._2._2} 说明：${v._2._2._1} 分区？${v._2._2._2}"))
    ...
    //***************************************************************************************************
    //*******************************          聚合操作  使用旧版本的mapReduceTriplets操作        *****************************************
    //***************************************************************************************************
    //    println("**********************************************************")
    //    println("聚合操作")
    //    println("**********************************************************")
