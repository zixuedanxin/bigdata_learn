...
object GraphXExample {
  def main(args: Array[String]) {
    ...
    //构造vertexRDD和edgeRDD
    val vertexRDD: RDD[(Long, (String, Int))] = sc.parallelize(vertexArray)// 构造点
    val edgeRDD: RDD[Edge[Int]] = sc.parallelize(edgeArray) // 构造边

    //构造图Graph[VD,ED]
    val graph: Graph[(String, Int), Int] = Graph(vertexRDD, edgeRDD) // 构造图
