...
import streamings.kafka.KafkaService
import streamings.radio.{SimpleSongAggregation, SimpleSongAggregationKafka}
...
object CassandraDriver extends LazyLogger {
  ...
  val foreachTableSink = "streamings/radio"
