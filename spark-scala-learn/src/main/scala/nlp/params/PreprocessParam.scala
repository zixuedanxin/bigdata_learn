...
class PreprocessParam extends Serializable  {
  val kvMap: mutable.LinkedHashMap[String, String] = Conf.loadConf("src/main/resource/preprocess.properties")

  val stopwordFilePath: String = kvMap.getOrElse("stopword.file.path", "data/classnews/stopwords.txt")    //停用词表路径
