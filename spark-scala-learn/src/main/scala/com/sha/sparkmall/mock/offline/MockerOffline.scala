package com.sha.sparkmall.mock.offline
...
import com.sha.sparkmall.mock.util.{RanOpt, RandomDate, RandomNum, RandomOptions}
import com.sha.sparkmall.common.model.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
...
//    insertHive(sparkSession, "city_info", cityInfoDF)
  ...
  def mockUserAction() = {
    ...
    val startDate = new SimpleDateFormat("yyyy-MM-dd").parse("2019-04-09")
    val endDate = new SimpleDateFormat("yyyy-MM-dd").parse("2019-04-11")
