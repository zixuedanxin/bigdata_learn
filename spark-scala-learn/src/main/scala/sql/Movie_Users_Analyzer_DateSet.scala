...
/**
  * Spark商业案例书稿第一章：1.12.3.3 DateSet方式案例代码
  * 版权：DT大数据梦工厂所有
  * 时间：2017年1月19日；
...
object Movie_Users_Analyzer_DateSet {
  ...
  def main(args: Array[String]){
    ...
    var dataPath = "data/moviedata/large/"  //数据存放的目录；
    ...
    val aa: Dataset[Rating] =genderRatingsDataSet.as[Rating]
    ...
    val femaleFilteredRatingsDataSet: DataFrame = genderRatingsDataSet.filter("Gender= 'F'").select("MovieID", "Rating")
