package com.xuzh.practice

import com.xuzh.beans.RptAppIspName
import com.xuzh.utils.Jtools
import com.xuzh.config.ConfigHelper
import com.xuzh.utils.Jtools
...
/**
  ...
  */
object AppDataDistributedJedisCore {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val baseDataset: Dataset[(String, Seq[Double])] = dataFrame.mapPartitions(rdd => {
      val jedis: Jedis = Jtools.getJedisPool
    ...
    baseDataset.rdd.map(tp => (tp._1, tp._2)).reduceByKey {
